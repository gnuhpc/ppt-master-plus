...
- First `.env` found in this order: current working directory, skill directory (e.g. `~/.agents/skills/ppt-master-plus/.env`), clone repo root, `~/.ppt-master-plus/.env`, then legacy fallback `~/.ppt-master/.env`
