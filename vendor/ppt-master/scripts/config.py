...
# The engine is vendored at <plus>/vendor/ppt-master/scripts. Runtime assets,
# configuration, and projects continue to belong to the outer Plus skill.
...
USER_CONFIG_DIR = Path.home() / '.ppt-master-plus'
LEGACY_USER_CONFIG_DIR = Path.home() / '.ppt-master'
...
# config consumers.
SVG_CONSTRAINTS = {
    'authority': 'skills/ppt-master-plus/references/ppt-master-core/shared-standards.md',
    'core_authority': 'skills/ppt-master-plus/references/ppt-master-core/shared-standards-core.md',
    'conditional_authorities': {
        'effects': 'skills/ppt-master-plus/references/ppt-master-core/svg-effects.md',
        'native_data': 'skills/ppt-master-plus/references/ppt-master-core/native-data-interface.md',
        'pptx_structure': 'skills/ppt-master-plus/references/ppt-master-core/pptx-structure-interface.md',
    },
    'validator': 'skills/ppt-master-plus/scripts/svg_quality_checker.py',
}
