...
from template_intake import build_template_artifacts  # noqa: E402
...
def run_intake(
    ...
    *,
    ...
    if intent == "template":
        ...
        raise ValueError(f"Unsupported PPTX intake intent: {intent}")
    return outputs
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="source",
        help="Treat the PPTX as content source facts or as a reusable design skeleton",
    )
    parser.add_argument(
        "--no-previews",
        action="store_true",
        help="Skip rendering template page thumbnails",
    )
    return parser
