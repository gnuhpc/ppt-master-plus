...
_VENDORED_TEMPLATES_DIR = _SCRIPTS_DIR.parent / "templates"
_PLUS_OVERLAY_TEMPLATES_DIR = _SCRIPTS_DIR.parents[2] / "templates"
_TEMPLATES_DIR = (
    _PLUS_OVERLAY_TEMPLATES_DIR
    if _PLUS_OVERLAY_TEMPLATES_DIR.is_dir()
    else _VENDORED_TEMPLATES_DIR
)
...
class VisualizationEntry:
    ...
    def display_path(self) -> str:
        ...
        return self.path.relative_to(_TEMPLATES_DIR.parent).as_posix()
