...
_GLOBAL_SOUNDS_DIR = Path(__file__).resolve().parents[3] / "templates" / "sounds"
...
def _run_sync(argv: list[str]) -> int:
    ...
    if missing:
        ...
        print(
            "Review `skills/ppt-master-plus/templates/sounds/sound-vocabulary.md`, then "
            "optionally run `python3 skills/ppt-master-plus/scripts/sound_sync.py list "
