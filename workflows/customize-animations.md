...
```bash
python3 skills/ppt-master-plus/scripts/animation_config.py list-groups <project_path>
```
...
```bash
python3 skills/ppt-master-plus/scripts/animation_config.py scaffold <project_path>
```
