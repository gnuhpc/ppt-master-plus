...
| Existing `.pptx` + asks to fill new content into a native design | Not supported; route as main-pipeline source material, beautify the existing content, or create/register an internal template package first |
