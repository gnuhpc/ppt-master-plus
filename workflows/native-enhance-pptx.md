...
```bash
python3 skills/ppt-master-plus/scripts/native_enhance_pptx.py init "<source.pptx>" --name "<project_slug>"
```
...
```bash
python3 skills/ppt-master-plus/scripts/native_enhance_pptx.py plan "<project>"
```
...
```bash
python3 skills/ppt-master-plus/scripts/native_enhance_pptx.py validate "<project>"
```
...
```bash
python3 skills/ppt-master-plus/scripts/notes_to_audio.py "<project>" \
...
```bash
python3 skills/ppt-master-plus/scripts/native_enhance_pptx.py apply "<project>"
```
...
```bash
python3 skills/ppt-master-plus/scripts/source_to_md/ppt_to_md.py \
