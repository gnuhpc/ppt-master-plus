...
python3 skills/ppt-master-plus/scripts/svg_editor/server.py <project_path> --no-browser
...
```bash
python3 skills/ppt-master-plus/scripts/visual_review.py <project_path>
```
...
- Path to the rubric: `skills/ppt-master-plus/references/visual-review.md`
