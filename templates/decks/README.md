...
Full data model: [`docs/zh/templates-architecture.md`](../../references/templates-architecture.md).

---

## Trigger rule

Deck selection is **opt-in by explicit path**. The main workflow defaults to free design. A deck is only used when the user gives an explicit directory path in their initial message (e.g. `skills/ppt-master-plus/templates/decks/招商银行/`). Bare names do not trigger. See [`SKILL.md`](../../SKILL.md) Step 3.
...
- [`docs/zh/templates-architecture.md`](../../references/templates-architecture.md) — three-class data model + fusion rules
