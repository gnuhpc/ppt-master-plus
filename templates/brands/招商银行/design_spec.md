...
# China Merchants Bank Transaction Banking Brand Specification

> Identity-only Brand preset. The former page roster is intentionally excluded;
> compose each new page freely under these brand constraints.
