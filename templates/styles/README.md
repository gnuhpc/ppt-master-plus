...
1. Enter [`workflows/internal/template-authoring/create-template.md`](../../workflows/internal/template-authoring/create-template.md), which dispatches method/default output to [`create-style.md`](../../workflows/internal/template-authoring/create-style.md).
